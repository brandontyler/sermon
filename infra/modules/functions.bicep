// Function App — Python 3.12, Linux, Basic plan (avoids Dynamic quota)
// NOTE: Function App names are globally unique, so we add a stable suffix.
...
var funcName = toLower('psr-functions-${environment}-${suffix}')
var planName = 'psr-plan-${environment}'
  ...
  properties: {
    ...
    siteConfig: {
      ...
      appSettings: [
        ...
        // Must be lowercase; using funcName keeps it unique and within constraints.
        { name: 'WEBSITE_CONTENTSHARE', value: funcName }
