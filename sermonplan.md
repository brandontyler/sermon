...
### Open Decisions
- [ ] Scoring calibration strategy — normalization curves are hardcoded estimates (topical +5/+8/+10 for biblical categories). After 20-30 scored sermons across types, revisit with real data. Current baselines after POC #11 recalibration (2026-03-06d): Spurgeon "Compel Them" = 88.4 (highest), Piper "Romans 8:28" = 85.6, Scheer "Best Life" = 80.9, Scheer "Elect Exiles" = 77.5, Scheer "Cultivating Joy" = 75.0, Piper "Don't Waste" = 74.6, **Pastor Chad "Trust the Process" = 23.2 (bad sermon benchmark)**. Biblical gravity cap prevents bad sermons from scoring above ~30.
